...
CREATE TABLE `T_SYS_ADMIN_LOGIN_ROLE` (
  ...
  PRIMARY KEY (`ID`),
  KEY `I_ADMIN_LOGIN_ROLE__USING_STATUS` (`USING_STATUS`),
  KEY `I_ADMIN_LOGIN_ROLE__INSERT_TIME` (`INSERT_TIME`),
  KEY `I_ADMIN_LOGIN_ROLE__LOGIN_ID` (`LOGIN_ID`),
  KEY `I_ADMIN_LOGIN_ROLE__ROLE_ID` (`ROLE_ID`)
