...
if(!opts.buttons){
opts.buttons=[{iconCls:'lk-icon-ok',text:opts.ok,onClick:function(){
_2ad(dlg);
}}];
}
var dlg=_2b2(opts);
...
opts.buttons=[{iconCls:'lk-icon-ok',text:opts.ok,onClick:function(){
_2ad(dlg,true);
}},{iconCls:'lk-icon-cancel',text:opts.cancel,onClick:function(){
_2ad(dlg,false);
}}];
}
var dlg=_2b2(opts);
...
var otherAttr = '';if(_4c5.getAttribute('maxlength')>0){otherAttr+=' maxlength="'+_4c5.getAttribute('maxlength')+'"';}
if(opts.multiline){
$("<textarea class=\"textbox-text\" autocomplete=\"off\""+otherAttr+"></textarea>").prependTo(tb);
}else{
$("<input type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"off\""+otherAttr+">").prependTo(tb);
}
...
var td=$("<td></td>").appendTo(tr);
var tool=$("<a href=\"javascript:void(0)\"></a>").appendTo(td);
if((typeof opts.toolbar[i].tip != 'undefined')){tool.tooltip({content:opts.toolbar[i].tip,showDelay:1000,position:'top',onShow:function(){$(this).tooltip('tip').css({borderColor:'#428bca'});}});}
tool[0].onclick=eval(btn.handler||function(){
});
tool.linkbutton($.extend({},btn,{plain:true}));
}
