...
import com.lichkin.framework.springboot.entities.impl.SysWechatMenuEntity;
...
public class LKWechatConfigMenuService extends LKDBService {
	...
	public String publishMenu(final Menu menu) throws Exception {
		...
		logger.info(json);
		return LKRequestUtils.doRequestStream(LKStringUtils.replaceDatas(LKWechatConfigStatics.menuCreateUrl, new LKDatas().put("#access_token", accessTokenServie.getAccessToken())), json);
	}
