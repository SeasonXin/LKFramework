...
import com.lichkin.framework.springboot.entities.impl.SysSmsEntity;
import com.lichkin.framework.springboot.services.LKDBService;
import com.lichkin.framework.utils.LKSmsHaiYanSender;
 ...
 */
@Service
public class LKSysSmsService extends LKDBService {
	 ...
	 */
	@Transactional
	public void sendSms(final String systemTag, final LKSmsSenderEnum sender, final LKPrototypeEnum busType, final String cellphone, final String message, final boolean threaded) {
		// 参数验证
		...
		// 保存短信
		final SysSmsEntity sms = new SysSmsEntity();
	 ...
	 */
	@Transactional
	public void sendSms(final LKSmsSenderEnum sender, final LKPrototypeEnum busType, final String cellphone, final String message, final boolean threaded) {
